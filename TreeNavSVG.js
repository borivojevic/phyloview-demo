...
define([
    ...
    var size = { width:geometry.position(query(containerName)[0]).w, height: canvasHeight};
    ...
    setTree : function(treeString, labelsInit, labelAliasInit) {
        ...
        size = { width:geometry.position(query(this.containerName)[0]).w - this.margin.left - this.margin.right, height: canvasHeight - this.margin.top - this.margin.bottom};
